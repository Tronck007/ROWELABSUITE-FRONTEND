  ...
  actions: {
    async getCatalogAllEquipment() {
      try {
        ...
        this.catalogEquipment.sort((a, b) => a.combined.localeCompare(b.combined))
    ...
    async getCatalogTestById(id) {
      try {
        ...
        this.catalogTest = Object.values(uniqueTests).sort((a, b) => a.test_desc.localeCompare(b.test_desc))
