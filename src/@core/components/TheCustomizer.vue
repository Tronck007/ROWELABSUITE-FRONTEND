...
import { useTheme as useThemeCustom } from '../../stores/theme/theme'

const useThemeStore = useThemeCustom()
...
const resetCustomizer = async () => {
  ...
  console.log('Customizer reset', customPrimaryColor.value)
}
...
<template>
  <div class="d-lg-block d-none">
    ...
    <VNavigationDrawer
      v-model="useThemeStore.isNavDrawerOpen"
      temporary
      touchless
      border="0"
      location="end"
      ...
      <div class="customizer-heading d-flex align-center justify-space-between">
        ...
        <div class="d-flex align-center gap-1">
          ...
          <VBtn
            ...
            color="medium-emphasis"
            size="small"
            @click="useThemeStore.toggleNavDrawer"
          >
            <VIcon
              icon="tabler-x"
              size="22"
